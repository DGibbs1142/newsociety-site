...
const DEMO_ARTICLES = [
  ...
  { source:'Demo Wire', published_at:new Date().toISOString(), title:'Fifth Placeholder Drop', description:'Once the feed reconnects, these get replaced with real fashion headlines.', url:'#' },
